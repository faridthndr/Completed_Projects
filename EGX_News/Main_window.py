...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Timer.setGeometry(QtCore.QRect(190, 30, 51, 22))
        self.Timer.setObjectName("Timer")
        self.Tmerlable_2 = QtWidgets.QLabel(self.groupBox_5)
        self.Tmerlable_2.setEnabled(True)
        self.Tmerlable_2.setGeometry(QtCore.QRect(236, 32, 41, 20))
        font = QtGui.QFont()
        font.setPointSize(9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Tmerlable_2.setText(_translate("MainWindow", "Min"))
