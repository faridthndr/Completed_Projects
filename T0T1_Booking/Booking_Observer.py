...
#-------------------------------------------------------------------------------------AZURE------------------------- 
    ...
    try:
        ...
        current_values = Alert_Sheet.get('B2:D') 
        new_values = [[''] * 3] * len(alert_results) + current_values  
        print(new_values)
        Alert_Sheet.update('B2:D', alert_results + new_values)  
        new_values = []



        # Alert_Sheet.insert_rows(alert_results, row=2)
